        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SSORequired = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SsoURL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SsoLogo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    SecondaryThemeColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    noOfSemesters = table.Column<long>(type: "bigint", nullable: false),
                    DurationInMonths = table.Column<long>(type: "bigint", nullable: false),
                    InstitutionId = table.Column<long>(type: "bigint", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sessions_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FacultyPrograms_Programs_ProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LevelCourses_Programs_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "Programs",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Candidates_Faculties_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "Faculties",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Candidates_Programs_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "Programs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Candidates_Semesters_SemesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeveDepartmentCourses", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CandidatesCurrentStates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CandidatesCurrentStates_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CandidatesCurrentStates_Levels_LevelId",
                        column: x => x.LevelId,
                        principalTable: "Levels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CandidatesCurrentStates_Semesters_SemesterId",
                        column: x => x.SemesterId,
                        principalTable: "Semesters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CandidatesCurrentStates_Sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_InstitutionId",
                table: "AspNetUserRoles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Candidates_ProgramId",
                table: "Candidates",
                column: "ProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_Candidates_SemesterId",
                table: "Candidates",
                column: "SemesterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidatesCurrentStates_CandidateId",
                table: "CandidatesCurrentStates",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidatesCurrentStates_LevelId",
                table: "CandidatesCurrentStates",
                column: "LevelId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidatesCurrentStates_SemesterId",
                table: "CandidatesCurrentStates",
                column: "SemesterId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidatesCurrentStates_SessionId",
                table: "CandidatesCurrentStates",
                column: "SessionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacultyPrograms_ProgramId",
                table: "FacultyPrograms",
                column: "ProgramId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LevelCourses_ProgramId",
                table: "LevelCourses",
                column: "ProgramId");
