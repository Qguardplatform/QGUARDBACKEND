        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivationTokenExpiresOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    ProfilePixUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sender = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Receiver = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    ...
                    CorrellationId = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Template_Code = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoleId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    PriviledgeId = table.Column<long>(type: "bigint", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePriviledges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RolePriviledges_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RolePriviledges_Priviledges_PriviledgeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePriviledges_PriviledgeId",
                table: "RolePriviledges",
                column: "PriviledgeId");

            migrationBuilder.CreateIndex(
                name: "IX_RolePriviledges_RoleId",
                table: "RolePriviledges",
                column: "RoleId");
